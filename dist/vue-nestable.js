(function (global, factory) {
  ...
  Watcher.prototype.update = function update$$1() {
    /* istanbul ignore else */
    if (this.lazy) {
      this.dirty = true;
    } else if (this.sync) {
  ...
  var ref = {
    ...
    update: function update$$1(oldVnode, vnode) {
  ...
  var show = {
    ...
    update: function update$$1(el, ref, vnode) {
      var value = ref.value;
