...
(function (global, factory) {
            ...
            var Simple = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"component-example"},[_c('vue-nestable',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
            var item = ref.item;
            return _c('vue-nestable-handle',{attrs:{"item":item}},[_vm._v(" "+_vm._s(item.text)+" ")])}}]),model:{value:(_vm.nestableItems),callback:function ($$v) {_vm.nestableItems=$$v;},expression:"nestableItems"}})],1)},staticRenderFns: [],_scopeId: 'data-v-d2aaa23c',
              data: function data () {
                return {
                  nestableItems: [
                    {
            ...
            var Advanced = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"component-example"},[_c('vue-nestable',{attrs:{"max-depth":2},scopedSlots:_vm._u([{key:"default",fn:function(ref){
            var item = ref.item;
            return [_c('vue-nestable-handle',{attrs:{"item":item}},[_vm._v(" ☰ ")]),_vm._v(" "),_c('span',[_vm._v("Item :: "+_vm._s(item.text))])]}}]),model:{value:(_vm.nestableItems),callback:function ($$v) {_vm.nestableItems=$$v;},expression:"nestableItems"}})],1)},staticRenderFns: [],_scopeId: 'data-v-65eab15c',
              data: function data () {
                return {
                  nestableItems: [
                    {
              ...
              methods: {
                ...
                getItemByPath: function getItemByPath (path, items) {
                  ...
                  path.forEach(function (index) {
                    var list = item ? item[this$1.childrenProp] : items;
                    item = list[index];
                  });
